	...
	return {
		...
		fn(state) {
			...
			if (element && isRef(element)) {
				if (element.current != null) return arrow$3({
					element: element.current,
					padding
				}).fn(state);
				return {};
			}
			if (element) return arrow$3({
				element,
				padding
			}).fn(state);
			return {};
...
//#endregion
export { Button, DialogBackdrop, DialogClose, DialogDescription, DialogPopup, DialogPortal, DialogRoot, DialogTitle, Input, PopoverPopup, PopoverPortal, PopoverPositioner, PopoverRoot, PopoverTrigger, Separator, TooltipArrow, TooltipPopup, TooltipPortal, TooltipPositioner, TooltipRoot, TooltipTrigger, arrow$2 as arrow, autoUpdate, flip, hide$1 as hide, limitShift, mergeProps, offset, require_jsx_runtime, require_react, require_react_dom, require_with_selector, shift, size, useFloating, useRender };
