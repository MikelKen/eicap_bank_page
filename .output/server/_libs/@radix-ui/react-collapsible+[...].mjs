...
import { Primitive, createContextScope, useComposedRefs, useLayoutEffect2 } from "./react-avatar+[...].mjs";
...
//#endregion
export { CollapsibleContent, CollapsibleTrigger, Presence, Root, useControllableState, useId };
