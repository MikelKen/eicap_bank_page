...
import { arrow, autoUpdate, flip, hide, limitShift, offset, require_jsx_runtime, require_react, require_react_dom, shift, size, useFloating } from "../@base-ui/react+[...].mjs";
import { Primitive, createContextScope, createSlot, dispatchDiscreteCustomEvent, useCallbackRef as useCallbackRef$1, useComposedRefs, useLayoutEffect2 } from "./react-avatar+[...].mjs";
...
//#endregion
export { Anchor, Content, Content2, FocusScope, Item2, Label2, Portal$1 as Portal, Portal2, ReactRemoveScroll, Root2, Root2$1, Separator2, Trigger, createPopperScope, hideOthers, useFocusGuards };
