...
import { require_jsx_runtime, require_react, require_react_dom } from "../@base-ui/react+[...].mjs";
import { Primitive, createContextScope, createSlot, useCallbackRef, useComposedRefs, useLayoutEffect2 } from "./react-avatar+[...].mjs";
import { createCollection } from "../radix-ui__react-collection.mjs";
import { composeEventHandlers } from "../radix-ui__primitive.mjs";
import { Presence, useControllableState, useId } from "./react-collapsible+[...].mjs";
import { useDirection } from "../radix-ui__react-direction.mjs";
import { DismissableLayer } from "./react-dismissable-layer+[...].mjs";
import { Anchor, Content, FocusScope, Portal, ReactRemoveScroll, Root2$1 as Root2, createPopperScope, hideOthers, useFocusGuards } from "./react-dropdown-menu+[...].mjs";
...
//#endregion
export { Select, SelectContent, SelectIcon, SelectItem, SelectItemIndicator, SelectItemText, SelectPortal, SelectScrollDownButton, SelectScrollUpButton, SelectTrigger, SelectValue, SelectViewport };
