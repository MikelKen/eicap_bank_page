...
//#endregion
export { GLOBAL_TSR, HeadContent, Link, Outlet, RouterProvider, Scripts, TSR_SCRIPT_BARRIER_ID, _getRenderedMatches, bindSsrResponseToRequest, createFileRoute, createInlineCssPlaceholderAsset, createInlineCssStyleAsset, createLRUCache, createRootRouteWithContext, createRouter, decodePath, defineHandlerCallback, dehydrateSsrMatchId, disposeSsrResponseDetached, executeRewriteInput, getScriptPreloadAttrs, getStylesheetHref, invariant, isNotFound, isRedirect, isResolvedRedirect, isSsrResponse, lazyRouteComponent, normalizeSsrResponse, redirect, renderRouterToStream, replaceSsrResponse, resolveManifestAssetLink, resolveManifestCssLink, rootRouteId, stripSsrResponseBody, useLocation, useNavigate, useRouter };
