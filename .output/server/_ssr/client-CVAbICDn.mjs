...
import { DialogContent, DialogDescription, DialogFooter, DialogHeader, DialogTitle, Route$5, useDialog, useLoader } from "./router-LQQOMst4.mjs";
...
import { clientService, useClientMineListQuery } from "./useQuery-CItDbTTk.mjs";
...
//#region node_modules/.nitro/vite/services/ssr/assets/client-CVAbICDn.js
...
function FormClient({ dialogId, close }) {
	const mutation = useClientCreateMutation(dialogId);
	const [sex, setSex] = (0, import_react.useState)("M");
	const [birthDate, setBirthDate] = (0, import_react.useState)(/* @__PURE__ */ new Date());
	return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(DialogContent, {
		...
		children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("form", {
			...
			children: [
				/* @__PURE__ */ (0, import_jsx_runtime.jsxs)(DialogHeader, { children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(DialogTitle, { children: "Crear Cliente" }), /* @__PURE__ */ (0, import_jsx_runtime.jsx)(DialogDescription, { children: "Completa los datos para crear un nuevo cliente." })] }),
