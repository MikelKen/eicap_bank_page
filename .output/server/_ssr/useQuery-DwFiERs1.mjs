import { ClientListPaginatedSchema, ClientSchema, parseResponse } from "./router-DYX03kjF.mjs";
...
//#region node_modules/.nitro/vite/services/ssr/assets/useQuery-DwFiERs1.js
var ClientService = class {
	...
	async update(id, input) {
		return await parseResponse(api.put(ENDPOINTS.CLIENTS.DETAIL(id), input), _null());
	}
	async delete(id) {
		return await parseResponse(api.delete(ENDPOINTS.CLIENTS.DETAIL(id)), _null());
	}
};
