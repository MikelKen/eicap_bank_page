import { BankOperationListPaginatedSchema, PaginatedResponse, PaginationSchema, parseResponse } from "./router-DYX03kjF.mjs";
...
//#region node_modules/.nitro/vite/services/ssr/assets/useQuery.account-CNuQhRIn.js
...
object({
	client_id: string().min(1, "Cliente es requerido"),
	type_account_id: string().min(1, "Tipo de cuenta es requerido"),
...
var AccountService = class {
	...
	async create(input) {
		return await parseResponse(api.post(ENDPOINTS.ACCOUNTS.BASE, input), _null());
	}
};
...
//#endregion
export { accountService, bankOperationService, useAccountsByClientQuery, useBankOperationsByActiveSessionQuery, useBankOperationsByClientQuery };
