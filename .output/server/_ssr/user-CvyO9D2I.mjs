...
import { DialogContent, DialogDescription, DialogFooter, DialogHeader, DialogTitle, Route$1, useDialog, useLoader } from "./router-LQQOMst4.mjs";
...
import { useUserListQuery, userService } from "./useQuery.user-RMUA0tf4.mjs";
//#region node_modules/.nitro/vite/services/ssr/assets/user-CvyO9D2I.js
...
function FormUser({ dialogId, close }) {
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(DialogContent, {
		...
		children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("form", {
			...
			children: [
				/* @__PURE__ */ (0, import_jsx_runtime.jsxs)(DialogHeader, { children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(DialogTitle, { children: "Crear Usuario" }), /* @__PURE__ */ (0, import_jsx_runtime.jsx)(DialogDescription, { children: "Completa los datos para crear un nuevo usuario." })] }),
